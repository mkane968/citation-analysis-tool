...
def analyze_rhetorical_moves(sentence_info):
    ...
    # Use the ML classifier to predict the rhetorical move
    rhetorical_move, confidence = rhetorical_classifier.predict_rhetorical_move(sentence)
    
    # If the sentence has a citation but the classifier didn't detect a rhetorical move,
    # default to "Reporting" as it's the most common move with citations
    if has_citation and rhetorical_move == "Transforming" and confidence < 0.6:
